...
from jobvacancy_sub.models.request.assignment import AssignmentRequest
from jobvacancy_sub.models.data.jobvacancy import Assignment
from jobvacancy_sub.services.assignments import AssignmentSubmissionService, AssignmentService
...
@router.post("/assignments/jobvacancy")
...
@router.post('/assignments/probationer/submit')
...
@router.post('/assignments/probationer/workbin')
def create_workbin(stud_id:int, jobvacancy_id:int): 
    assignment_submission_service:AssignmentSubmissionService = AssignmentSubmissionService()
    result, bin_id = assignment_submission_service.create_workbin(stud_id, jobvacancy_id)
    if result == True: 
