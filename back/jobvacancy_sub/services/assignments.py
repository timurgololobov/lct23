...
from jobvacancy_sub.repository.assignments import AssignmentRepository, AssignmentSubmissionRepository
...
class AssignmentSubmissionService: 
    ...
    def create_workbin(self, stud_id:int, jobvacancy_id:int): 
        bin_id = uuid4().int
        result = self.repo.create_bin(stud_id, bin_id, jobvacancy_id )
